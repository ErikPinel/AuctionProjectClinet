...
function DisplayItemMen()
{
  ...
  useEffect(()=>{
    const fetchPosts= async()=>{
        setloading(true);
        axios.get("/api-itemMen/itemmen").then((res) => {
    ...
    const fetchPostsLtoH= async()=>{
      ...
      axios.post("/api-itemMen/itemmen/lowToHigh").then((res) => {
  ...
  const fetchPostsHtoL= async()=>{
    setloading(true);
    axios.post("/api-itemMen/itemmen/highToLow").then((res) => {
...
const fetchPostsUpVote= async()=>{
  setloading(true);
  axios.post("/api-itemMen/itemmen/upVote").then((res) => {
...
const fetchPostsSearch= async()=>{
  setloading(true);
  axios.post("/api-itemMen/itemmen/search",{filter:filter}).then((res) => {
