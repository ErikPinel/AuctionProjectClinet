...
function handleInput(e)
{
  ...
  return (
    ...
    <Form className="d-flex">
      ...
      <span style={{fontSize:"2vw"}}> filters :<Button  onClick={()=>{setFilter("lowToHigh")}} className="category-btn">from lowest- highest</Button><Button onClick={()=>{setFilter("highToLow")}} className="category-btn">from highest - lowest</Button><Button onClick={()=>setFilter("upVote")} className="category-btn">most upvoted items</Button></span>
     <ul>
